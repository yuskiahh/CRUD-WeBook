<?php
  ...
  if(isset($_GET['id_buku'])) {
      ...
      if(!count($data)){
        echo "<script>alert('Data yang anda cari tidak ditemukan');window.location='dashboard.php';</script>";    
      }

  } else {
      echo "<script>alert('Masukkan data yang ingin diedit');window.location='dashboard.php';</script>";
  }
?>
<!DOCTYPE html>
<html>
